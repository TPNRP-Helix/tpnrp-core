...
To get started with TPNRP Core, check out the [Installation Guide](./getting-started/installation.md).

## Resources

- [GitHub Repository](https://github.com/TPNRP/tpnrp-core)
- [API Reference](./api/server/core.md)
